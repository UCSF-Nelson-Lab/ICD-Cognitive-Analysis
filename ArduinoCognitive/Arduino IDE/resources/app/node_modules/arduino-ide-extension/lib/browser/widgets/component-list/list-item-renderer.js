...
let ListItemRenderer = class ListItemRenderer {
    ...
    renderItem(input, install, uninstall, onVersionChange) {
        ...
        const installButton = item.installable && (React.createElement("button", { className: "theia-button secondary install", onClick: onClickInstall }, common_1.nls.localize('arduino/component/install', 'INSTALL')));
        ...
        return (React.createElement("div", { className: "component-list-item noselect" },
            ...
            focus && (React.createElement("div", { className: "footer" },
                versions,
                installButton))));
    }
};
