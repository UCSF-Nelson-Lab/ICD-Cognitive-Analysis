...
let CloudSketchbookCompositeWidget = class CloudSketchbookCompositeWidget extends widget_1.BaseWidget {
    constructor() {
        ...
        this.title.caption = common_1.nls.localize('arduino/cloud/remoteSketchbook', 'Remote Sketchbook');
...
__decorate([
    (0, inversify_1.inject)(cloud_sketchbook_tree_widget_1.CloudSketchbookTreeWidget),
