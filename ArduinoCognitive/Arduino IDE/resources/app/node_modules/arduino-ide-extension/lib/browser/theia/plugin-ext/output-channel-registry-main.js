...
let OutputChannelRegistryMainImpl = class OutputChannelRegistryMainImpl extends output_channel_registry_main_1.OutputChannelRegistryMainImpl {
    $append(name, text, pluginInfo) {
        this.commandService.executeCommand(output_commands_1.OutputCommands.APPEND.id, {
            name,
            text,
        });
    ...
    async $reveal(name, preserveFocus) {
        ...
        this.commandService.executeCommand(output_commands_1.OutputCommands.SHOW.id, {
            name,
            options,
        });
    }
