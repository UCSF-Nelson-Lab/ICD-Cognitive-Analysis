...
const notification_toasts_component_1 = require("@theia/messages/lib/browser/notification-toasts-component");
class NotificationToastsComponent extends notification_toasts_component_1.NotificationToastsComponent {
    render() {
