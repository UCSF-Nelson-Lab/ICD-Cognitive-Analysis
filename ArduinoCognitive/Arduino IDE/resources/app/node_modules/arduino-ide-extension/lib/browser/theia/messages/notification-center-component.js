            ...
            React.createElement("div", { className: "theia-notification-center-header" },
                ...
                React.createElement("div", { className: "theia-notification-center-header-actions" },
                    React.createElement("ul", { className: "theia-notification-actions" },
                        React.createElement("li", { className: (0, browser_1.codicon)('chevron-down', true), title: common_1.nls.localize('vscode/notificationsStatus/hideNotifications', 'Hide Notification Center'), onClick: this.onHide }),
                        React.createElement("li", { className: (0, browser_1.codicon)('clear-all', true), title: common_1.nls.localize('vscode/notificationsCommands/clearAllNotifications', 'Clear All'), onClick: this.onClearAll })))),
