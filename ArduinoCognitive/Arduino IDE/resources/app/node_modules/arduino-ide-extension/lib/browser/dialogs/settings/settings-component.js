    ...
    renderSettings() {
        ...
        return (React.createElement("div", { className: "content noselect" },
            ...
            React.createElement("div", { className: "column-container" },
                ...
                React.createElement("div", { className: "column" },
                    React.createElement("div", { className: "flex-line" },
                        React.createElement(settings_step_input_1.default, { value: this.state.editorFontSize, setSettingsStateValue: this.setFontSize, step: fontSizeStep, maxValue: maxFontSize, minValue: minFontSize, classNames: { input: 'theia-input small' } })),
                    React.createElement("div", { className: "flex-line" },
                        React.createElement("label", { className: "flex-line" },
                        ...
                        React.createElement("div", null,
                            React.createElement(settings_step_input_1.default, { value: scalePercentage, setSettingsStateValue: this.setInterfaceScale, step: scaleStep, maxValue: maxScale, minValue: minScale, unitOfMeasure: "%", classNames: { input: 'theia-input small with-margin' } }))),
                    React.createElement("div", { className: "flex-line" },
