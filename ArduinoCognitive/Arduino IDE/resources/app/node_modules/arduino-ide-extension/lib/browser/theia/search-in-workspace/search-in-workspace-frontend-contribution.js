...
let SearchInWorkspaceFrontendContribution = class SearchInWorkspaceFrontendContribution extends search_in_workspace_frontend_contribution_1.SearchInWorkspaceFrontendContribution {
    constructor() {
        super();
    ...
    registerKeybindings(keybindings) {
        ...
        keybindings.unregisterKeybinding(search_in_workspace_frontend_contribution_1.SearchInWorkspaceCommands.OPEN_SIW_WIDGET);
    }
};
